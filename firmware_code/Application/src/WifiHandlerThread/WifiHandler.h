...
#ifndef SECRET_H_
#define MAIN_WLAN_SSID "yunerzhang"           /**< Destination SSID. Change to your WIFI SSID */
#define MAIN_WLAN_AUTH M2M_WIFI_SEC_WPA_PSK /**< Security manner */
#define MAIN_WLAN_PSK "1134852071as"      /**< Password for Destination SSID. Change to your password. Please dont hack my WiFi router */
#endif                                      /* SECRET_H_ */
...
#define MAIN_HTTP_FILE_URL "http://52.224.120.179/Application.bin"  ///< Change me to the URL to download your OTAU binary file from!
...
// new topics for EnvSensorTask
#define ENV_DATA_TOPIC    "env/data"
// new topics for ControlTask
#define MOTION_TOPIC    "robot/mode"
// topic for servo angles to Node-RED
#define SERVO_ANGLES_TOPIC "robot/servo_angles"
// OTA
#define OTA_COMMAND_TOPIC   "device/ota_command"
 ...
 */
static const char main_mqtt_broker[] = "52.224.120.179";
...
bool is_state_set(download_state mask); // Add this line to expose the function
// Control
