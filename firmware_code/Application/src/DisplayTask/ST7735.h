/**
 * @file    ST7735.h
 * @brief   ST7735 TFT LCD definitions and drawing interface.
 *
 * Contains ASCII character bitmaps, ST7735 command macros, pin configuration,
 * screen dimensions, color definitions, and function declarations for LCD control.
 * Supports drawing pixels, characters, strings, rectangles, and sending SPI data.
 */
...
#define DAT_PIN PIN_PA21
#define SLAVE_SELECT_PIN PIN_PA22
...
#define CONF_MASTER_PINMUX_PAD2 PINMUX_PA24D_SERCOM5_PAD2
#define CONF_MASTER_PINMUX_PAD3 PINMUX_PA25D_SERCOM5_PAD3
